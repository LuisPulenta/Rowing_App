...
//-----------------------------------------------------------------
  ...
  Future<void> _getCertificaciones() async {
    ...
    response = await ApiHelper.getCertificaciones(
        widget.user.modulo.toString(), widget.user.idUsuario);
                            ...
                            Expanded(
                              child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Row(
                                      children: [
                                        Text(e.codigoproduccion.toString(),
                                            style: const TextStyle(
                                              fontSize: 12,
                                            )),
                                      ],
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text(_certificaciones.length.toString(),
              style: const TextStyle(
                fontSize: 14,
                color: Colors.white,
                fontWeight: FontWeight.bold,
...
//-----------------------------------------------------------------
  ...
  _borrarCabeceraCertificacion(CabeceraCertificacion e) async {
    await showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
              ...
              TextButton(
                  onPressed: () async {
                    Response response = await ApiHelper.delete(
                        '/api/CabeceraCertificacion/', e.id.toString());
