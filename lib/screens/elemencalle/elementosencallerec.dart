  ...
  Widget _showObra() {
    return Row(
      children: [
        ...
        Expanded(
          child: Text(widget.elemEnCalle.nombreObra,
  ...
  Widget _showAddress() {
    return Row(
      children: [
        ...
        Expanded(
          child: Text(widget.elemEnCalle.domicilio,
              style: const TextStyle(
                fontSize: 12,
              )),
        ),
  ...
  Widget _showObservaciones() {
    return Row(
      children: [
        ...
        Expanded(
          child: Text(widget.elemEnCalle.observacion,
              style: const TextStyle(
                fontSize: 12,
              )),
        ),
                ...
                child: !_photoChanged
                    ? Center(
                        child: FadeInImage(
                          ...
                          image: NetworkImage(widget.elemEnCalle.imageFullPath),
                        ),
                      )
                    : Center(
                        child: Image.file(
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Expanded(
                                    flex: 1,
                                    child: Text(e.cantidad2.toString(),
                                        style: const TextStyle(
                                          fontSize: 14,
                                          color: Colors.blue,
                                          fontWeight: FontWeight.bold,
