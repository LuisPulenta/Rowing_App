      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          String? result = await Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => VeredaAgregarScreen(
                        user: widget.user,
                        obra: widget.obra,
                      )));
          if (result != 'zzz') {
          ...
          _obrasReparos.isEmpty
              ...
              : Row(
                  children: [
                    ...
                    const Text('Cant. Veredas: ',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: 14,
                            fontWeight: FontWeight.bold)),
                    Text(_obrasReparos.length.toString(),
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(e.cantidadMTL.toString(),
                                          style: const TextStyle(
                                            fontSize: 12,
                                          )),
                                    ),
                                ...
                                Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(e.profundidad.toString(),
                                          style: const TextStyle(
                                            fontSize: 12,
                                          )),
                                    ),
